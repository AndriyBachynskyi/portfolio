...
const Experience = () => {
    return (
        <div className='border-b border-neutral-900 pb-4'>
            <h2 className='my-20 text-center text-4xl font-medium tracking-normal'>Experience</h2>
            <div>
                {EXPERIENCES.map((experience, index) => (
                    <div key={index} className='mb-12 flex flex-wrap lg:justify-center'>
                        <div className='w-full lg:w-1/4'>
                            <p className='mb-1 font-thin'>{experience.year}</p>
                            <p className='font-thin text-sm'>{experience.location}</p>
                        </div>
